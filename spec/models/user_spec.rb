  ...
  describe ".find_or_create_with_omniauth" do
    ...
    context "user doesnt exists" do
      ...
      describe "setting data on new user" do
        ...
        it { subject.location.should == "Rio de Janeiro, Rio de Janeiro" }
